...
import { Digit, digitsFromUrlParam, genRandomTargetDest } from './Common';
...
function getBitQueryParams(): {bits: Digit[]|null, targetBits: Digit[]|null } {
    ...
    return { bits: digitsFromUrlParam(searchParams.get("bits"))
...
const PuzzleSession: FC = () => {
    ...
    let [bitsGen, targetBitsGen] = genRandomTargetDest();
